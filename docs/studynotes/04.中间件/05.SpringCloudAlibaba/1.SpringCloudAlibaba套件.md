...
![cloud升级](笔记.assets/20200719190509386.webp)
...
![image-20220511101455073](笔记.assets/image-20220511101455073.webp)
...
![image-20220511102132155](笔记.assets/image-20220511102132155.webp)
...
![image-20220511102420216](笔记.assets/image-20220511102420216.webp)
...
![image-20220511102753504](笔记.assets/image-20220511102753504.webp)
...
![image-20220511110113938](笔记.assets/image-20220511110113938.webp)
...
![image-20220511104925452](笔记.assets/image-20220511104925452.webp)
...
![image-20220511111057154](笔记.assets/image-20220511111057154.webp)
...
![image-20220511135032044](笔记.assets/image-20220511135032044.webp)
...
![image-20220511141543002](笔记.assets/image-20220511141543002.webp)
...
![image-20220511142336865](笔记.assets/image-20220511142336865.webp)
...
![image-20220512071408321](笔记.assets/image-20220512071408321.webp)

#### 8.2 短信服务使用 

接下来,我们使用**短信验证码功能**来演示短信服务的使用。流程如下:

![image-20220512071452234](笔记.assets/image-20220512071452234.webp)
...
![image-20220512071532141](笔记.assets/image-20220512071532141.webp)

###### 8.2.1.3 申请认证秘钥

![image-20220512071543255](笔记.assets/image-20220512071543255.webp)

###### 8.2.1.4 申请短信签名

![image-20220512071552748](笔记.assets/image-20220512071552748.webp)

###### 8.2.1.5 申请短信模板

![image-20220512071602729](笔记.assets/image-20220512071602729.webp)
...
![image-20220512100856753](笔记.assets/image-20220512100856753.webp)
...
![image-20220512102216608](笔记.assets/image-20220512102216608.webp)
...
![image-20220512103347461](笔记.assets/image-20220512103347461.webp)

2 新建一个名为`service-product-test.yaml`配置存放测试环境的配置

![image-20220512104043640](笔记.assets/image-20220512104043640.webp)

3 新建一个名为`service-product-dev.yaml`配置存放开发环境的配置

![image-20220512104125105](笔记.assets/image-20220512104125105.webp)
...
![image-20220512104303078](笔记.assets/image-20220512104303078.webp)
...
![image-20220512104822792](笔记.assets/image-20220512104822792.webp)
...
![image-20220512105713156](笔记.assets/image-20220512105713156.webp)

- 多个微服务访问同一个数据库
  多个服务需要调用一个数据库实例完成数据的增删改操作

![image-20220512105735992](笔记.assets/image-20220512105735992.webp)

- 多个微服务访问多个数据库
  多个服务需要调用不同的数据库实例完成数据的增删改操作

![image-20220512105838295](笔记.assets/image-20220512105838295.webp)
...
![image-20220512111423464](笔记.assets/image-20220512111423464.webp)
...
![image-20220512111228120](笔记.assets/image-20220512111228120.webp)
...
![image-20220512111529758](笔记.assets/image-20220512111529758.webp)
...
![image-20220512112553503](笔记.assets/image-20220512112553503.webp)
...
![image-20220513132130415](笔记.assets/image-20220513132130415.webp)

另一种情况：

![image-20220513132149846](笔记.assets/image-20220513132149846.webp)
...
![image-20220513132339272](笔记.assets/image-20220513132339272.webp)
...
![image-20220513134136547](笔记.assets/image-20220513134136547.webp)
...
![image-20220513134648567](笔记.assets/image-20220513134648567.webp)
...
![image-20220513151214966](笔记.assets/image-20220513151214966.webp)
...
![image-20220513152224240](笔记.assets/image-20220513152224240.webp)
...
![image-20220513153544975](笔记.assets/image-20220513153544975.webp)